avr-gcc -DCONFIGFILE=cfg-noctigon-kr4-nofet.h -Wall -g -Os -mmcu=attiny1634 -c -std=gnu99 -fgnu89-inline -fwhole-program -DATTINY=1634 -I.. -I../.. -I../../.. -fshort-enums -o anduril.o -c anduril.c
...
mv -f anduril.hex anduril.emisar-d4v2-e21a.hex
